...
<h1 style="width:70%;margin:10vh auto 5px auto;">
    <?php echo $c_name ?>
</h1>
<div class='main' style="display:flex;">
    <div id="chartdiv" style="margin:10% 0 4% 2%;display:flex">
    </div>
    <div class='right' style="display: flex; flex-direction: column;margin:5% 0;">
      <div id="radardiv" style="height:70%;width:100%;display:flex;max-height:400px;">
      </div>
      <div class='desc'  style="height:30%;margin:0 auto;display:flex;">
