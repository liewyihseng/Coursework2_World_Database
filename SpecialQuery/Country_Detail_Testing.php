<?php
    ...
    echo '<link rel="stylesheet" href="../Select/Select_Style.css">';
    echo '<link rel="stylesheet" href="../css/insert_style.css">';
    echo '<link rel="icon" href="../css/globe.png">';
    echo '<link rel="stylesheet" type="text/css" media="only screen and (max-device-width: 1300px)" href="phonetesting.css" />';
    echo '<link rel="stylesheet" type="text/css" media="only screen and (min-device-width: 1301px)" href="normal.css" />';
